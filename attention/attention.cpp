...
at::Tensor sdpa(
  ...
  attention(Q_ptr, K_ptr, V_ptr, O_ptr, bs, q_head, kv_head, len_q, len_kv, dim, causal);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("sdpa_v2", &sdpa<attention_v2>, 
        py::arg("Q"), py::arg("K"), py::arg("V"), py::arg("causal") = false,
        "Scaled Dot-Product Attention v2");

  m.def("sdpa_v3", &sdpa<attention_v3>, 
        py::arg("Q"), py::arg("K"), py::arg("V"), py::arg("causal") = false,
        "Scaled Dot-Product Attention v3");

  m.def("sdpa_v4", &sdpa<attention_v4>, 
        py::arg("Q"), py::arg("K"), py::arg("V"), py::arg("causal") = false,
        "Scaled Dot-Product Attention v4");

  m.def("sdpa_v5", &sdpa<attention_v5>, 
        py::arg("Q"), py::arg("K"), py::arg("V"), py::arg("causal") = false,
        "Scaled Dot-Product Attention v5");

  m.def("sdpa_v6", &sdpa<attention_v6>, 
        py::arg("Q"), py::arg("K"), py::arg("V"), py::arg("causal") = false,
        "Scaled Dot-Product Attention v6");
}
